...
exports.voiceGenerate = catchAsyncError(async (req, res, next) => {
    ...
    const directory = `./user/${storyTitle}}/speech`;
...
async function imagePromptGeneration(story, prpt) {
    ...
    const prewrittenPrompts = [
        ...
        "Now you will give me the prompt string as string named 'prompt' and give it in this format 'prompt'='prompt_txt' And  the style string as string named 'style' and give it in this format 'style'='style_text' "
    ];
...
exports.imageGenerate = catchAsyncError(async (req, res, next) => {
    ...
    try {
        ...
        const directory = `./user/${storyTitle}}/images`;
